...
class ORMFixture:
    ...
    def convert_contacts_to_model(self, contacts):
        def convert(contact):
            return Contact(id=str(contact.id), first_name=contact.firstname, surname=contact.lastname, address=contact.address,
                           land_line=contact.home, mobile=contact.mobile, work=contact.work, fax=contact.fax, land_line_2=contact.phone2,
